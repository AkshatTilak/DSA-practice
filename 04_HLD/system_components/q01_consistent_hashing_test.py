...
try:
    ...
    from q01_consistent_hashing_sandbox import ConsistentHashRing
except ImportError:
    # Fallback to standard solution
    from q01_consistent_hashing import ConsistentHashRing
    try:
        source = inspect.getsource(ConsistentHashRing)
        if "pass" in source:
            # Load optimal version for verification out of the box
            from q01_consistent_hashing import ConsistentHashRing_optimal as ConsistentHashRing
    except Exception:
        pass
