...
try:
    ...
    from q06_support_vector_machines_sandbox import solve
except ImportError:
    # Fallback to standard solution
    from q06_support_vector_machines import solve
    try:
        source = inspect.getsource(solve)
        if "pass" in source:
            # Load optimal version for verification out of the box
            from q06_support_vector_machines import solve_optimal as solve
    except Exception:
        pass
