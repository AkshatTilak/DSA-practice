...
try:
    ...
    from q08_redundant_connection_sandbox import solve
except ImportError:
    # Fallback to standard solution
    from q08_redundant_connection import solve
    try:
        source = inspect.getsource(solve)
        if "pass" in source:
            # Load optimal version for verification out of the box
            from q08_redundant_connection import solve_optimal as solve
    except Exception:
        pass
